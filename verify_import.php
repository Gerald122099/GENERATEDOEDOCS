...
if (isset($_POST['insert_data'])) {
    ...
    foreach ($tables as $table) {
        ...
        if (!$mysql->query("SELECT 1 FROM `$table` LIMIT 1")) {
            $importErrors[] = "<div class='alert alert-warning'>Table $table doesn't exist in MySQL - skipping</div>";
            continue;
        }
        ...
        foreach ($rows as $row) {
            ...
            if (!$mysql->query($sql)) {
                $importErrors[] = "<div class='alert alert-danger'>Error inserting into $table: " . $mysql->error . "</div>";
                $importErrors[] = "<pre class='error-details'>SQL: " . htmlspecialchars($sql) . "</pre>";
            }
        }
    }
    ...
    if (empty($importErrors)) {
        echo "<script>Swal.fire('Success!', 'Data import completed!', 'success');</script>";
    }
}
?>
        ...
        <div class="card mt-4">
            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <button type="submit" class="btn btn-success mb-3">Import to MySQL</button>
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade <?php echo $i === 0 ? 'show active' : ''; ?>" 
                            ...
                            <h5 class="mt-3">Table Structure</h5>
                            <table class="table table-bordered table-structure">
                                <thead>
                                    <tr>
                                        <th>Column Name</th>
                                        <th>Data Type</th>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $col['notnull'] ? 'NO' : 'YES'; ?></td>
                                    </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
